        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-5rem)]">
          ...
          <div className="text-center lg:text-left order-2 lg:order-2 space-y-6">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Computer Science student at <span className="text-gradient font-semibold animate-slide-up">NIT Trichy</span> with expertise in <span className="text-gradient font-semibold animate-slide-up">Full-Stack Development</span>, <span className="text-gradient font-semibold animate-slide-up">AI/ML</span>, and <span className="text-gradient font-semibold animate-slide-up">Modern Automation Technologies</span>.<br />Passionate about building <span className="text-gradient font-semibold animate-slide-up">Innovative Solutions</span> and delivering <span className="text-gradient font-semibold animate-slide-up">Impactful Projects</span>.
            </p>
